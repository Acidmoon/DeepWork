...
const uiText = {
  'zh-CN': {
    ...
    homeWorkspaceStartHint: '先选择一个工作区，再开始保存网页对话、CLI 会话和后续索引。这里负责决定写入位置，不负责管理档案列表。',
    homeWorkspaceNotSelected: '尚未选择工作区',
    homeResumeTitle: '继续当前工作区',
    homeQuickOpenTitle: '快速重开已保存工作区',
    homeQuickOpenHint: '这里只保留少量快速重开入口。重命名、设为启动默认和移除档案仍在设置里处理。',
    ...
    workspaceInspectionFlowHint: '先确认来源，再看对话详情，最后检查相关记录和预览。',
    logsInspectionFlowHint: '先筛选日志来源，再浏览记录，最后打开原文预览。',
    workspaceSearch: '搜索查询',
    workspaceSearchPlaceholder: '搜索 ID、摘要、标签或路径',
    searchResultsCount: '搜索结果',
    contextType: '内容类型',
    inspectionFilterNone: '未限定',
    filterThreadScope: '线程范围',
    filterSourceScope: '来源范围',
    ...
    sourceOrigins: '来源索引',
    sessionList: '来源列表',
    currentSelectionSummary: '来源详情',
    sessionPreview: '对话时间线',
    ...
    logRecords: '日志记录',
    logPreview: '日志预览',
    logPreviewHint: '先选择一条日志记录。',
    logInspectionHint: '日志面用于检查终端转录、检索审计和排障记录，不会把内容发送给 CLI。',
    logsSourceHint: '先选择一个日志来源，或保持“全部来源”继续浏览。',
    ...
    remoteBridgeSettings: '飞书远程操作',
    remoteBridgeSettingsHint: '配置会保存到远程桥接配置文件，默认不启用。',
    remoteBridgeEnable: '启用远程桥接',
    remoteBridgeEnableHint: '启用前需要飞书凭据、允许的群聊和允许的用户。',
    remoteBridgeTargetMode: '目标模式',
    remoteBridgePtyMode: 'PTY 终端模式',
    remoteBridgeCodexAppServerMode: 'Codex app-server 模式',
    remoteBridgeIntakeMode: '接收模式',
    remoteBridgePollingMode: '轮询',
    remoteBridgeApiBase: '飞书 API Base',
    remoteBridgePollingIntervalMs: '轮询间隔（毫秒）',
    feishuAppId: '飞书 App ID',
    feishuAppSecret: '飞书 App Secret',
    feishuVerificationToken: '飞书 Verification Token',
    feishuEncryptKey: '飞书 Encrypt Key',
    remoteBridgeAllowedChatIds: '允许的群聊 ID',
    remoteBridgeAllowedUserIds: '允许的用户 ID',
    remoteBridgeAdminUserIds: '管理员用户 ID',
    remoteBridgeEnabledPanelIds: '允许远程操作的面板 ID',
    remoteBridgeDefaultPanelId: '默认面板 ID',
    remoteBridgeOnePerLine: '每行一个 ID',
    remoteBridgeOutputLimits: '输出限制',
    remoteBridgeOutputLimitsHint: '控制 tail、单条飞书消息和输出合并频率。',
    remoteBridgeMaxTailCharacters: 'Tail 最大字符数',
    remoteBridgeMaxMessageCharacters: '单条消息最大字符数',
    remoteBridgeDebounceMs: '输出合并延迟（毫秒）',
    remoteBridgeProactiveDelivery: '主动推送输出',
    remoteBridgeProactiveDeliveryHint: '开启后会把重要输出主动推送到飞书，仍受长度和频率限制。',
    remoteBridgeLockSettings: '锁与本地活动',
    remoteBridgeLockSettingsHint: '协调手机端输入和本地终端输入，避免同时写入同一个会话。',
    remoteBridgeLockTimeoutMs: '远程锁超时（毫秒）',
    remoteBridgeLocalActivityBlockMs: '本地输入阻止窗口（毫秒）',
    remoteBridgeAllowLockOwnerDuringLocalActivity: '锁持有者可覆盖本地活动',
    remoteBridgeAllowLockOwnerHint: '开启后，远程锁持有者在本地活动窗口内仍可发送普通输入。',
    remoteBridgeCliStart: '启动远程模式',
    remoteBridgeCliStartDone: '远程模式已开启',
    remoteBridgeCliModeRunning: '飞书远程控制已指向当前 Codex CLI。',
    remoteBridgeCliModeStopped: '飞书远程控制尚未开启。',
  ...
  'en-US': {
    ...
    homeWorkspaceStartHint: 'Choose a workspace first, then start saving web conversations, CLI sessions, and later indexes into it. Home decides the active write location and does not manage the full profile list.',
    homeWorkspaceNotSelected: 'No workspace selected',
    homeResumeTitle: 'Resume Current Workspace',
    homeQuickOpenTitle: 'Quick Open Saved Workspaces',
    homeQuickOpenHint: 'Only a few quick reentry shortcuts appear here. Rename, startup default, and removal stay in Settings.',
    ...
    workspaceInspectionFlowHint: 'Confirm the source first, then inspect conversation detail, related records, and preview.',
    logsInspectionFlowHint: 'Filter log sources first, then browse records, then open raw preview.',
    workspaceSearch: 'Search Query',
    workspaceSearchPlaceholder: 'Search by ID, summary, tags, or path',
    searchResultsCount: 'results',
    contextType: 'Content Type',
    inspectionFilterNone: 'Unfiltered',
    filterThreadScope: 'Thread Scope',
    filterSourceScope: 'Source Scope',
    ...
    sessionList: 'Sources',
    currentSelectionSummary: 'Source Detail',
    sessionPreview: 'Conversation Timeline',
    ...
    currentSessionContent: 'Related Records',
    ...
    sourceDetailHint: 'Select a source from the left to inspect captured detail.',
    ...
    logPreviewHint: 'Select a log record first.',
    ...
    logsSourceHint: 'Select a log source, or keep All Sources to browse archived records.',
    ...
    remoteBridgeSettings: 'Feishu Remote Work',
    remoteBridgeSettingsHint: 'Configuration is saved to the remote bridge config file and stays disabled by default.',
    remoteBridgeEnable: 'Enable Remote Bridge',
    remoteBridgeEnableHint: 'Feishu credentials, allowed chats, and allowed users are required before enabling.',
    remoteBridgeTargetMode: 'Target Mode',
    remoteBridgePtyMode: 'PTY terminal mode',
    remoteBridgeCodexAppServerMode: 'Codex app-server mode',
    remoteBridgeIntakeMode: 'Intake Mode',
    remoteBridgePollingMode: 'Polling',
    remoteBridgeApiBase: 'Feishu API Base',
    remoteBridgePollingIntervalMs: 'Polling Interval (ms)',
    feishuAppId: 'Feishu App ID',
    feishuAppSecret: 'Feishu App Secret',
    feishuVerificationToken: 'Feishu Verification Token',
    feishuEncryptKey: 'Feishu Encrypt Key',
    remoteBridgeAllowedChatIds: 'Allowed Chat IDs',
    remoteBridgeAllowedUserIds: 'Allowed User IDs',
    remoteBridgeAdminUserIds: 'Admin User IDs',
    remoteBridgeEnabledPanelIds: 'Remote-enabled Panel IDs',
    remoteBridgeDefaultPanelId: 'Default Panel ID',
    remoteBridgeOnePerLine: 'One ID per line',
    remoteBridgeOutputLimits: 'Output Limits',
    remoteBridgeOutputLimitsHint: 'Controls tail size, Feishu message size, and output coalescing frequency.',
    remoteBridgeMaxTailCharacters: 'Max Tail Characters',
    remoteBridgeMaxMessageCharacters: 'Max Message Characters',
    remoteBridgeDebounceMs: 'Output Debounce (ms)',
    remoteBridgeProactiveDelivery: 'Proactive Output Delivery',
    remoteBridgeProactiveDeliveryHint: 'When enabled, important output is pushed to Feishu within length and rate limits.',
    remoteBridgeLockSettings: 'Lock and Local Activity',
    remoteBridgeLockSettingsHint: 'Coordinates mobile input with local terminal input so both sides do not write at once.',
    remoteBridgeLockTimeoutMs: 'Remote Lock Timeout (ms)',
    remoteBridgeLocalActivityBlockMs: 'Local Activity Block Window (ms)',
    remoteBridgeAllowLockOwnerDuringLocalActivity: 'Allow Lock Owner During Local Activity',
    remoteBridgeAllowLockOwnerHint: 'When enabled, the remote lock owner can send normal input during the local activity window.',
    remoteBridgeCliStart: 'Start Remote Mode',
    remoteBridgeCliStartDone: 'Remote Mode On',
    remoteBridgeCliModeRunning: 'Feishu remote control points to this Codex CLI.',
    remoteBridgeCliModeStopped: 'Feishu remote control is not enabled.',
