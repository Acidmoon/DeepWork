...
const uiText = {
  'zh-CN': {
    ...
    threadEmptyHint: '当前还没有线程。开始一次新线程后，后续网页、CLI 和手动保存都会继续落到这里。',
    ...
    selectedArtifactsEmpty: '当前还没有勾选任何 Artifact，可先从上面的列表里选择你要检查的记录。',
    artifactPreview: 'Artifact 预览',
    artifactPreviewHint: '选择一条 Artifact 进行按需加载预览，不会影响你当前勾选的检查列表。',
  ...
  'en-US': {
    ...
    threadEmptyHint: 'No threads exist yet. Start a new thread and later web, CLI, and manual captures will continue here.',
    ...
    selectedArtifactsEmpty: 'No artifacts are selected yet. Pick records from the list above when you want to inspect them together.',
    artifactPreview: 'Artifact Preview',
    artifactPreviewHint: 'Pick one artifact to preview on demand without changing the checkbox selection used for your inspection list.',
