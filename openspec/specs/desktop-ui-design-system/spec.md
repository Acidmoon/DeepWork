...
## Purpose
Define the renderer-wide visual language, component density, accessible command treatment, responsive layout behavior, and theme constraints for the modern minimal desktop workbench UI.
